...
public class Employee {
    ...
    public Employee() {
        ...
        departments.put("HR", "Hyman Resources");
    ...
    public Map<String, String> getCarBrands() { return carBrands; }

    public void setCarBrands(Map<String, String> carBrands) { this.carBrands = carBrands; }
